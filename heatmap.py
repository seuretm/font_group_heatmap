#
# This code is highly based on the following:
# https://github.com/jacobgil/pytorch-grad-cam
# The main differences are:
# - Some visualizations possibilities have been removed,
# - All heatmaps are normalized together so that they can be compared
# - The heatmap is built patch-wise, so that large images can be
#   processed
#
...
def get_args():
	...
	parser.add_argument('--image_path', type=str, default='./examples/page.jpg', help='Input image path')
...
if __name__ == '__main__':
	...
	for target_index in range(nb_classes):
		...
		dst = os.path.join('output', '%s_%s.jpg' % (output_name, tgc.classMap.id2cl[target_index]))
